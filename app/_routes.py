...
# from flask import Flask, session, url_for, render_template, flash,json,jsonify
#
# # import os
# # from app import app
# # from flask import render_template, request, redirect
...
# # from flask import Flask, session, url_for, render_template, flash,json,jsonify
# #
# # #from app.models import model                     #from models import models
# # import io
# # import random
# # import matplotlib.pyplot as plt
# # import matplotlib.image as mpimg
...
# #         advice += "<br>If you eat off of glass plates and cut down on the number of plastic or paper plates you buy, your negative impact on the environment will greatly decrease, based on your current plastic-usage habits. I know washing dishes is a pain, but in the end, it is worth it!"
# #
